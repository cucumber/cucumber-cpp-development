...
class CucumberCppDevelopment(ConanFile):
    name = "cucumber-cpp-development"
    version = "0.1.0"
    package_type = "library"

    license = "MIT"
    url = "https://github.com/cucumber/cucumber-cpp-development"
    homepage = "https://github.com/cucumber/cucumber-cpp-development"
    description = "Cucumber C++ Development"
    ...
    def package_info(self):
        self.cpp_info.set_property("cmake_file_name", "cucumber-cpp-development")
        self.cpp_info.set_property("cmake_target_name", "cucumber::cpp_development")
        self.cpp_info.libs = ["cucumber-cpp-development"]
